      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-500 text-sm">Réglages — Accès administrateur</p>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <label className="text-zinc-400 text-xs uppercase tracking-widest mb-1.5 block">Code d'accès</label>
            <input
              type="password"
              value={adminPinInput}
            ...
            <button onClick={checkAdminPin} className="w-full h-12 bg-green-600 hover:bg-green-500 text-white font-bold rounded-xl transition-all">
              Accéder
            </button>
          </div>
        </div>
